import CartMetod from "./CartAddCounter/CartMetod"
import Book from "./cartDom/Book";
import MusicAlbum from "./cartDom/MusicAlbum";
import Movie from "./cartDom/Movie";
import Device from "./cartDom/Device";
const cart = new CartMetod();
console.log(cart.items);

cart.add(new Book(1001, "War and Piece", "Leo Tolstoy", 2000, 1225));
cart.add(new MusicAlbum(1008, "DAvaU ZAdyU", "NEbro", 900));
cart.add(
	new Movie(
		1011,
		"The Avengers",
